...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<script type="text/javascript" >
		...
		var CreateTheOrder = function () {
			...
			var user = document.getElementById('autocomplete-hidden').value;
			ViewModel.CallServerMethod('CreateTheOrder', { productlist: jsonProductList ,selectedUser :user , ShowLoadingBar: true }, function (result) {
				if (result.Success) {
