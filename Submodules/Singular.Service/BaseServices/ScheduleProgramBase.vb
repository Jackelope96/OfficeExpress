...
Public MustInherit Class ScheduleProgramBase
  ...
  Private Sub TimeElapsed()
    ...
    Try
      ...
      If Not Service.ServiceUpdateEnabled Then

        'Get the service info from the database again
        ' initialize to blank to force refetch
        mServerProgramType = Nothing
        'Reset the schedule, as it may have changed
        _Schedule = Me.GetSchedule()
