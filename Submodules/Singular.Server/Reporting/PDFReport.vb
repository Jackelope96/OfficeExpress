...
#Region " Public Settings "
    ...
    Public Property DefaultFont As String = "Calibri"
...
#End Region
    ...
    Private Sub CreateSection(DataTable As DataTable, Title As String)
      ...
      If Orientation = Reports.Report.Preferences.Printing.PaperOrientation.Auto Then
      ...
      With mCurrentSection
        ...
        .PageNumbering.Style = SmallStyle
          ...
          For Each Column As DataColumn In Columns
            If AutoGenerateColumn(Column) Then
              With .Header.AddCell
                ...
                .Paddings.Left = ColumnPadding
                .Paddings.Right = ColumnPadding
                .Paddings.Top = 1
                .Paddings.Bottom = 1
                With .AddText
    ...
    Private Sub Setup()
      If MainHeaderStyle Is Nothing Then
        MainHeaderStyle = New Reports.Report.Text.Style(New Reports.Graphics.Font(DefaultFont, 16, Reports.Graphics.FontStyle.Bold), Reports.Graphics.Brushes.Black)
      End If
      If SubHeaderStyle Is Nothing Then
        SubHeaderStyle = New Reports.Report.Text.Style(New Reports.Graphics.Font(DefaultFont, 11), Reports.Graphics.Brushes.Black)
      End If
      If TableHeaderStyle Is Nothing Then
        TableHeaderStyle = New Reports.Report.Text.Style(New Reports.Graphics.Font(DefaultFont, 10, Reports.Graphics.FontStyle.Bold), Reports.Graphics.Brushes.Black)
      End If
      If GroupHeaderStyle Is Nothing Then
        GroupHeaderStyle = New Reports.Report.Text.Style(New Reports.Graphics.Font(DefaultFont, TableHeaderStyle.Font.Size + 1, Reports.Graphics.FontStyle.Bold), Reports.Graphics.Brushes.Black)
      End If
      If NormalStyle Is Nothing Then
        NormalStyle = New Reports.Report.Text.Style(New Reports.Graphics.Font(DefaultFont, 10), Reports.Graphics.Brushes.Black)
      End If
      If SmallStyle Is Nothing Then
        SmallStyle = New Reports.Report.Text.Style(New Reports.Graphics.Font(DefaultFont, 9), Reports.Graphics.Brushes.Black)
      End If
    End Sub
