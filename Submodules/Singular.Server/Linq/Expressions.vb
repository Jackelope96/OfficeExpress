  ...
  Public Class JavascriptExpressionParser(Of ObjectType)
    ...
    Protected Overrides Sub ParseMemberExpression(ByVal expr As MemberExpression)
      ...
      Else
        ...
        If (expr.Member.Name = "Model" OrElse expr.Member.Name = "ViewModel") AndAlso
          (GetType(System.Web.UI.Page).IsAssignableFrom(expr.Member.ReflectedType) OrElse GetType(System.Web.UI.Control).IsAssignableFrom(expr.Member.ReflectedType)) Then
          'Root special case
