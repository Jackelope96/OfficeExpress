...
Public Class Xml
  ...
  Public Shared Function CreateXML(PopulateBody As Action(Of XMLHelper)) As String
    ...
    Using xmlW = System.Xml.XmlWriter.Create(sb, New System.Xml.XmlWriterSettings With {.Encoding = System.Text.Encoding.UTF8})

      xmlW.WriteStartDocument()
      xmlW.WriteStartElement("Rows")

      PopulateBody(New XMLHelper(xmlW))
  ...
  Public Class XMLHelper
    ...
    Public Sub New(xmlW As System.Xml.XmlWriter)
      _xmlW = xmlW
    End Sub
