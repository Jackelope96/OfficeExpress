...
#If Silverlight Then
    ...
    End If
#Else
    Dim key As String = MemberInfo.DeclaringType.GetHashCode & MemberInfo.Name & GetType(A).GetHashCode
...
#If SILVERLIGHT = False Then
  ...
  Public Shared Function FetchList(ByVal ListOrCriteriaType As Type, ByVal Criteria As Object) As Object
    ...
    Dim FetchListMi = FetchMethod.MakeGenericMethod(ListType)
  ...
  Public Shared Function GetMemberSpecific(Of t, [return])(ByVal le As System.Linq.Expressions.Expression(Of System.Func(Of t, [return]))) As MemberInfo
    If le Is Nothing Then
      Return Nothing
    ElseIf TypeOf le.Body Is System.Linq.Expressions.MemberExpression Then
      Return CType(le.Body, System.Linq.Expressions.MemberExpression).Member
    ElseIf TypeOf le.Body Is System.Linq.Expressions.MethodCallExpression Then
      Dim mcExpr = CType(le.Body, System.Linq.Expressions.MethodCallExpression)
      Return mcExpr.Method
    Else

      Dim uExpr = CType(le.Body, System.Linq.Expressions.UnaryExpression)
      If TypeOf uExpr.Operand Is System.Linq.Expressions.MethodCallExpression Then
        Return CType(uExpr.Operand, System.Linq.Expressions.MethodCallExpression).Method
      ElseIf TypeOf uExpr.Operand Is System.Linq.Expressions.MemberExpression Then
        Return CType(uExpr.Operand, System.Linq.Expressions.MemberExpression).Member
      End If
    End If
    Return Nothing
  End Function
