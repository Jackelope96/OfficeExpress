...
#Region " Methods "
    ...
    Public Shared Function FetchChildren(ParentTableID As Integer, ParentRowID As Integer, Optional ByVal Levels As Integer = 1) As Tuple(Of ROAuditTrailTableList, ROAuditTrailUserList)

      'If ViewAuditTrailRole = "" OrElse Singular.Security.HasAccess(ViewAuditTrailRole) Then

      Dim ROAuditTrailTableList = AuditTrails.ROAuditTrailTableList.GetROAuditTrailTableList(Nothing, Nothing, ParentTableID, ParentRowID, Nothing, Nothing, Nothing)
    ...
    Public Sub FetchChildren(HeaderList As ROAuditTrailTableList, Optional ByVal Levels As Integer = 1)

      With FetchChildren(mAuditTrailTableID, mRowID, Levels)
      ...
      If Levels > 1 Then
        ROAuditTrailTableList.FetchChildren(HeaderList, Levels - 1)
      End If
