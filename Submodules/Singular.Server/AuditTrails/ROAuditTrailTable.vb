...
#Region " Methods "
    ...
    Public Sub PopulateInsertedDetails()
      ...
      Dim RowsWithInsertOnly = mROAuditTrailHeaderList.Where(Function(c) c.Type = 1)
      If RowsWithInsertOnly.Count > 0 Then
        ...
        mROAuditTrailHeaderList.BuildIndex(Function(c) c.RowID)
        ...
        cProc.ExecuteReaderLocal(
          Sub(sdr)
            ...
            While sdr.Read
              ...
              Dim ath = mROAuditTrailHeaderList.GetItemIndexed(sdr.GetInt32(0))
              Dim atd = New ROAuditTrailDetail
              atd.Populate(sdr.GetString(1), sdr.GetValue(2), sdr.GetString(3))
              ath.ROAuditTrailList(0).ROAuditTrailDetailList.Add(atd)
