...
#Else
  ...
  Public Shared Function GetStringHash(ByVal str As String, HashType As HashType, Optional ByVal IncludeOtherChars As Boolean = True, Optional ByVal Encoding As ASCIIEncoding = ASCIIEncoding.Unicode, Optional ByVal LowerCase As Boolean = False) As String

    ' If HashType <> Encryption.HashType.BCrypt Then

    Dim Hasher As HashAlgorithm

    If HashType = Encryption.HashType.MD5 Then
      Hasher = MD5.Create
    Else
  ...
  Public Shared Function GetEncryptedToken(Salt As String, Content As String) As String
    Return GetEncryptedToken(Salt & Chr(30) & Content)
  End Function
