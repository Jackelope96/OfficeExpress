...
#Region " Rules "
  ...
  'Protected Sub AddMultiplePropertyRule(RuleClassType As Type, Properties() As PropertyInfo)

  '  For Each pi As PropertyInfo In Properties
  '    BusinessRules.AddRule(Activator.CreateInstance(RuleClassType, Properties))
  '  Next

  '  For i As Integer = 0 To Properties.Length - 1
  '    For i2 As Integer = i To Properties.Length - 1
  '      If i <> i2 Then
  '        BusinessRules.AddRule(New Csla.Rules.CommonRules.Dependency(Properties(i), Properties(i2)))
  '      End If
  '    Next
  '  Next
