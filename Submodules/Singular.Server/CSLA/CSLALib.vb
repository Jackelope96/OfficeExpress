...
#Region "Get Dataset from Business Base New"
    ...
    Public Function GetDatasetFromBusinessListBase(ByVal List As Object, ByVal IgnoreReturnedCSLASingleObjects As Boolean, ByVal IgnoreChildObjectsCompletely As Boolean,
                                                   Optional AddExtendedProperties As Boolean = True, Optional UseDisplayAttributeOrder As Boolean = False, Optional AddNonClsaListChildren As Boolean = False)

      Dim ds As DataSet = New DataSet

      'Create The Root Table
      For Each obj In List
        AddBusinessBase(obj, ds, IgnoreReturnedCSLASingleObjects, IgnoreChildObjectsCompletely, AddExtendedProperties, UseDisplayAttributeOrder, AddNonClsaListChildren)
      Next
    ...
    Public Function GetDatasetFromBusinessBase(ByVal Obj As Object, ByVal IgnoreReturnedCSLASingleObjects As Boolean, ByVal IgnoreChildObjectsCompletely As Boolean,
                                                   Optional AddExtendedProperties As Boolean = True, Optional AddNonClsaListChildren As Boolean = False)
      Dim ds As DataSet = New DataSet
    ...
    Private Sub AddBusinessBase(Obj As Object, ByRef ds As DataSet, ByVal IgnoreReturnedCSLASingleObjects As Boolean, ByVal IgnoreChildObjectsCompletely As Boolean,
                                AddExtendedProperties As Boolean, Optional UseDisplayAttributeOrder As Boolean = False, Optional AddNonClsaListChildren As Boolean = False)
    ...
    Private Function AddColumns(pis As List(Of PropertyInfo), obj As Object, ByRef tbl As DataTable,
                                AddExtendedProperties As Boolean, Optional AddNonClsaListChildren As Boolean = False) As List(Of PropertyInfo)
