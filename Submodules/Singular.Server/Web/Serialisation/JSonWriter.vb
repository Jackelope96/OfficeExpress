...
Namespace Web.Data
  ...
  Public Class JSonWriter
    ...
    Public Property Serialiser As JS.JSSerialiser
    ...
    Public Shared Sub WriteJSonValue(Value As Object, sb As Text.StringBuilder, QuoteChar As Char)
      ...
      ElseIf TypeOf Value Is Byte Then
        sb.Append(CType(Value, Byte).ToString(System.Globalization.CultureInfo.InvariantCulture))
    ...
    Public Sub WriteArrayValueRaw(Value As Object)
      If mCurrentContext.FirstValue Then
        mCurrentContext.FirstValue = False
      Else
        mSB.Append(",")
    ...
    Public Sub WriteObject(PropertyName As String, Obj As Object, Optional Context As String = "", Optional RenderGuids As Boolean? = Nothing, Optional FullRender As Boolean = True)
      ...
      If Obj IsNot Nothing Then
        ...
        End If
        Serialiser.IsInitial = FullRender
    ...
    Public Shared Function SerialiseObject(List As Object, Optional Context As String = "", Optional RenderGuids As Boolean? = Nothing,
                                           Optional Output As OutputType = OutputType.JSon, Optional FullRender As Boolean = True) As String

      Dim jw As New Data.JSonWriter
      jw.OutputMode = Output
      jw.WriteObject("", List, Context, RenderGuids, FullRender)
      Return jw.ToString
