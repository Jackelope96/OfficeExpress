...
#If SILVERLIGHT = False Then
  ...
  Public Class SQLQueueReader
    ...
    Private mSyncDelegate As Action(Of Action(Of String), Action(Of Exception))
    ...
    Private Sub WaitForMessage(Callback As Action(Of String), ErrorCallback As Action(Of Exception))
          ...
          Using cn As New SqlClient.SqlConnection(Singular.Settings.ConnectionString)
            ...
            Using mLatestCommand = New SqlClient.SqlCommand("WAITFOR (RECEIVE CAST(message_body as XML) As [Message] FROM " & mQueueName & ")", cn)
              ...
              Catch ex As SqlClient.SqlException
                ...
                Else
                  'Timeout
                  If CallbackOnTimeout Then Callback(Data)
                End If
              End Try
