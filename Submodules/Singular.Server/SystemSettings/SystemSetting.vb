...
#Region "  .Net Data Access  "
    ...
    Public Shared AddExtraUpdateParameters As Action(Of SqlCommand)
    ...
    Protected Overrides Sub InsertUpdate(cm As SqlCommand)
      ...
      If IsDirty Then
        ...
        Service.NotifyService(Service.ServiceUpdateMessageType.SystemSettingsUpdated, Singular.Reflection.GetTypeFullName(Settings.GetType))
