    ...
    Protected Overrides Sub Render(writer As System.Web.UI.HtmlTextWriter)
      ...
      If TypeOf Page Is Data.IViewModelPage Then
        ...
        If Not Model.IsSendingFile Then
          ...
          writer.Write(CType(Page, Singular.Web.PageBase).EndPageHTML.ToString)
          ...
          CType(Page, Singular.Web.PageBase).WriteLateResources(writer)

          'Check if it needs json
          If Not Misc.BroswerInfo.SupportsJSon Then
            writer.Write("<script type=""text/javascript"" src=""" & VirtualPathUtility.ToAbsolute("~/Singular/Javascript/json2.js") & """></script>")
          End If
          ...
          End If
          Dim RootPath As String = VirtualPathUtility.ToAbsolute("~")
          jsw.Write("Singular.RootPath = '" & If(RootPath = "/", "", RootPath) & "';")
          jsw.Write("Singular.CurrentPath = '" & VirtualPathUtility.ToAbsolute(Page.AppRelativeVirtualPath) & "';")
          If Singular.Debug.InDebugMode Then
