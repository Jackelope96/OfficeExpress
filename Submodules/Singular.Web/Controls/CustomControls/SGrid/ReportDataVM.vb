...
#Region " Setup "
    ...
    Public Function IncludeGridReportResources() As String
      ...
      ResourceTags.AppendLine(Singular.Web.Scripts.RenderScriptGroup(Singular.Web.Scripts.ScriptGroupType.GridReport.ToString))
      ResourceTags.AppendLine(Singular.Web.Scripts.RenderScriptGroup(Singular.Web.Scripts.ScriptGroupType.SGrid.ToString))
      ResourceTags.AppendLine(Singular.Web.CSSFile.IncludeFontAwesome())
      'ResourceTags.AppendLine(Singular.Web.CSSFile.IncludeSGridStyles())
      ResourceTags.AppendLine(CSSFile.RenderStyleTag("~/Singular/CSS/SGrid.css"))
