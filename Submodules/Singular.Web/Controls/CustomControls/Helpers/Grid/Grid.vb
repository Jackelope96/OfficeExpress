...
#End Region
    ...
    Public Function AddStaticRows(Of ChildType)(Datasource As System.Linq.Expressions.Expression(Of Func(Of ObjectType, Object))) As StaticRowsInfo(Of ChildType)
      ...
      sri.Datasource = Singular.Linq.JavascriptExpressionParser(Of ObjectType).GetCachedOutput(Datasource, Linq.JavascriptExpressionParser(Of ObjectType).OutputModeType.KnockoutBinding, True, Linq.JavascriptExpressionParser(Of ObjectType).EqualsActionType.Compare, Linq.JavascriptExpressionParser(Of ObjectType).PropertyAccessType.AutoDetect).JavascriptString
      mStaticRows.Add(sri)
      AddControl(sri)
      Return sri
    End Function
    ...
    Public Function CreateAddNewButton(ButtonText As String) As Button(Of ObjectType)
      ...
      If Singular.Web.Controls.DefaultButtonStyle = ButtonStyle.Bootstrap Then
        mAddNewButton.Image.Glyph = FontAwesomeIcon.plusFilled
      End If
