...
#End Region
  ...
  Public Class DropDownEditor(Of t)
    ...
    Protected Friend Overrides Sub Setup()
      ...
      IsCombo = Type = DropDownWeb.SelectType.Combo OrElse Type = DropDownWeb.SelectType.FindScreen OrElse Type = DropDownWeb.SelectType.AutoComplete
      ...
      If IsCombo Then
        ...
        IsAutoComplete = PrimarySearchField IsNot Nothing
    ...
    Private Sub AddComboBindings()
      ...
      Else
        ...
        Else
          sb.Append(", Source: " & GetFilterSourceJS(DDA.ClientName))
        End If
    ...
    Private Sub AddHTMLSelectBindings()
      ...
      Else
        AddBinding(KnockoutBindingString.DropDown, "{Source: " & GetSourceJS() & "}")
      End If
    ...
    Private Function GetSourceJS() As String
      ...
      If DDA.ThisFilterMember <> "" OrElse DDA.FilterConstant IsNot Nothing OrElse DDA.FilterMethodName <> "" Then
        If mBindingMode = LocationType.Client Then
          ...
          SourcePath = GetFilterSourceJS(SourcePath)
    ...
    Private Function GetFilterSourceJS(SourcePath As String) As String
      If DDA.FilterMethodName <> "" Then
        Return DDA.FilterMethodName & "(" & SourcePath & ", " & "$data" & ")"
      Else
        If DDA.DataSourceFilterMember <> "" Then
          If DDA.FilterConstant IsNot Nothing OrElse DDA.ThisFilterMember = "" Then
            Return "Singular.FilterList(" & SourcePath & ", '" & DDA.DataSourceFilterMember & "', " & System.Web.Helpers.Json.Encode(DDA.FilterConstant).Replace("""", "'") & ")"
          Else
            Return "Singular.FilterList(" & SourcePath & ", '" & DDA.DataSourceFilterMember & "', " & GetContext(DDA.ThisFilterMember) & "())"
          End If
        End If
      End If
      Return SourcePath
    ...
    Protected Overrides Sub WriteOtherAttributes()
      ...
      If ShowFindScreen Then
        ...
        If CType(Page, PageBase).CanAddFindDialog(VMCriteriaPropertyName) Then
