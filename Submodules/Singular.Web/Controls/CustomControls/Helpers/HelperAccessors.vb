...
Namespace Controls
  ...
  Partial Public Class HelperControls
    ...
    Public Class HelperAccessors
      ...
      Protected mParentControl As Singular.Web.Controls.HelperControls.HelperBase
      Protected mControlsToRender As New List(Of HelperBase)
      Private mCachedHelper As Singular.Web.PageBase.ICachedHelper

      Public Sub New(Page As PageBase, ParentControl As Singular.Web.Controls.HelperControls.HelperBase)
        mPage = Page
      ...
      Friend Sub SetCached(CachedHelper As Singular.Web.PageBase.ICachedHelper)
...
#End Region
      ...
      Public ReadOnly Property ContextList As Singular.UIContextList
        Get
          ...
          Else
            Return Page.ModelNonGeneric.JSSerialiser.ContextList
          End If
        End Get
      End Property
      ...
      Public Sub AddSchemaType(Type As Type)
        ...
        Else
          Page.ModelNonGeneric.SchemaList.AddType(Type)
        End If
      End Sub
      ...
      Public Sub AddDropDownDataSource(DropDown As Singular.DataAnnotations.DropDownWeb)
        ...
        ElseIf Page IsNot Nothing Then
          Page.ModelNonGeneric.ClientDataProvider.AddDropDownDataSource(DropDown)
        End If
...
#Region "IDisposable Support"
      ...
      Protected Overridable Sub Dispose(disposing As Boolean)
        ...
        RenderToPage(Page.Response.Output)
...
#End Region
      ...
      ''' </summary>
      Public Overloads Function Control(ControlType As Type, Optional Container As Singular.Web.ContainerType = ContainerType.Div, Optional ID As String = "") As AjaxControlLoader
        Return SetupControl(New Singular.Web.CustomControls.AjaxControlLoader(ControlType, Container, ID))
      End Function
      ...
      ''' The control will not have any state.
      ''' </summary>
      Public Overloads Function Control(Of ControlType)(Optional Container As Singular.Web.ContainerType = ContainerType.Div, Optional ID As String = "") As AjaxControlLoader
        Return Control(GetType(ControlType), Container, ID)
      End Function
      ...
      Public Function PagedGridFor(Of ChildControlsObjectType)(ByVal PagingManager As System.Linq.Expressions.Expression(Of System.Func(Of ObjectType, Object)), ByVal TableList As System.Linq.Expressions.Expression(Of System.Func(Of ObjectType, Object)), ByVal AllowAddNew As Boolean, ByVal AllowRemove As Boolean) As PagedGrid(Of ObjectType, ChildControlsObjectType)
...
#Region " Bootstrap "
      ...
      Public Function BootstrapEditorRowFor(le As System.Linq.Expressions.Expression(Of System.Func(Of ObjectType, Object)), _
                                             Optional RowContainerClasses As String = "", _
