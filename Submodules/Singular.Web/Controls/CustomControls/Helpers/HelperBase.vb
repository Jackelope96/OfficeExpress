    ...
    Public MustInherit Class HelperBase(Of ObjectType)
      ...
      Private Sub EnsurePropertyInfo()
        ...
        If mPropertyInfo Is Nothing AndAlso mLinqExpression IsNot Nothing Then
          ...
          Dim Output = Singular.Linq.JavascriptExpressionParser(Of ObjectType).GetCachedOutput(mLinqExpression, Linq.JavascriptExpressionParser(Of ObjectType).OutputModeType.KnockoutBinding, True)
