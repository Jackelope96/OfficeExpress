...
#Region " Base Chart Control "
  ...
  Public MustInherit Class ChartControl(Of SettingsType As ChartSettings, ObjectType)
    ...
    Private Sub RegisterJQPlotCoreResources()
      ...
      CType(Page, Singular.Web.PageBase).AddLateResource("<link rel=""stylesheet"" type=""text/css"" href=""" & VirtualPathUtility.ToAbsolute(JQPlotCSSFile) & """ />")
      CType(Page, Singular.Web.PageBase).AddLateResource("<!--[if lt IE 9]><script type=""text/javascript"" src=""" & VirtualPathUtility.ToAbsolute("~/Singular/Javascript/Graphing/excanvas.min.js") & """></script><![endif]-->")
      CType(Page, Singular.Web.PageBase).AddLateResource(ChartJSFiles.JQPlotCore.ScriptTag)
      CType(Page, Singular.Web.PageBase).AddLateResource(ChartJSFiles.SingularGraphing.ScriptTag)
