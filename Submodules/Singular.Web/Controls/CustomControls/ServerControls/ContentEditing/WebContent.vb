    ...
    Public Property Name() As String
      ...
      Set(ByVal Value As String)
        ...
        If ContentEditing.StorageMode = StorageModeType.File Then
          'Load the html file
          Dim FilePath As String = System.Web.HttpContext.Current.Server.MapPath(ContentEditing.FileStorageDirectory & Name & FileSuffix & ".txt")
    ...
    Public Property HTMLContent() As String
      ...
      Set(ByVal Value As String)
        ...
        Else
          ...
          'Save to file
          Dim FilePath = System.Web.HttpContext.Current.Server.MapPath(ContentEditing.FileStorageDirectory & Name & FileSuffix & ".txt")
