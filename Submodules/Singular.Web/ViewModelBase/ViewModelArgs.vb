...
Public Class AjaxProgress
  ...
  ''' Updates all values and sends them to the client.
  ''' </summary>
  Public Sub Update(StatusText As String, Optional CurrentStep As Integer = -1)
