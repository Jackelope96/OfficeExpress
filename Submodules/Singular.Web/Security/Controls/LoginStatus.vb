  ...
  Public Class LoginStatus
    ...
    Protected Overrides Sub Render(writer As System.Web.UI.HtmlTextWriter)
      ...
      If Singular.Security.HasAuthenticatedUser Then
        ...
        writer.Write("</span><img src='" & VirtualPathUtility.ToAbsolute(LockClosedImage) & "' style='vertical-align:middle;' class='LockBreak' />")
        writer.Write("</div>")
        ...
        For Each mi As MenuItem In mil
          ...
          Else
            writer.Write("<div onclick=""window.location.href = '" & VirtualPathUtility.ToAbsolute(mi.Link) & "'"">" & mi.Text & "<img src='" & VirtualPathUtility.ToAbsolute(mi.ImageURL) & "' style='vertical-align:middle;' class='LockEdit'  /></div>")
          End If
        Next

        'Change Password
        If ChangePasswordUrl <> "" Then
          writer.Write("<div onclick=""window.location.href = '" & VirtualPathUtility.ToAbsolute(ChangePasswordUrl) & "'"">" & ChangePasswordText & "<img src='" & VirtualPathUtility.ToAbsolute(LockEditImage) & "' style='vertical-align:middle;' class='LockEdit'  /></div>")
        End If
        ...
        If LogoutUrl.StartsWith("~") Then
          LogoutUrl = VirtualPathUtility.ToAbsolute(LogoutUrl)
        End If
        writer.Write("<div onclick=""window.location.href = '" & LogoutUrl & "?SCmd=Logout'"">" & LogoutText & "<img src='" & VirtualPathUtility.ToAbsolute(LockLogoutImage) & "' style='vertical-align:middle;'  class='LockBreak' /></div>")
        writer.Write("</div>")
      ...
      Else
        ...
        writer.Write("<img src='" & VirtualPathUtility.ToAbsolute(LockOpenImage) & "' style='vertical-align:middle;' class='LockOpen' />")
      End If
