Namespace Security
  ...
  Public MustInherit Class SecurityControl(Of SGType)
    ...
    Protected Friend Overrides Sub Setup()
            ...
            With RolesTable
              ...
              With .AddChildTable(Of Singular.Security.ROSecurityRole)(Function(c) c.ROSecurityRoleList, False, False)
                ...
                With .FirstRow.AddColumn("Role")
                  ...
                  'Image
                  .Helpers.Image().AddBinding(Singular.Web.KnockoutBindingString.src, Function(c) "../Singular/Images/" & If(c.SelectedInd, "IconAuth.png", "IconError.png"))
                  'Check Box
      ...
      If IsStateless Then
        CType(Page, Singular.Web.PageBase).AddLateResource(Scripts.LibraryIncludes.SecurityScript.ScriptTag)
      End If
