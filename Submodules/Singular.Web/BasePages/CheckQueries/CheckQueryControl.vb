Namespace CheckQueryHelpers
  ...
  Public Class CheckQueryControl
    ...
    Protected Friend Overrides Sub Setup()
      ...
      With CType(Page, Singular.Web.PageBase)
        .AddLateResource(Scripts.LibraryIncludes.CheckQueriesScript.ScriptTag)
 
        .AddLateResource(Singular.Web.Scripts.RenderScriptGroup(Singular.Web.Scripts.ScriptGroupType.SGrid.ToString))
        .AddLateResource(Singular.Web.CSSFile.IncludeSGridStyles)
      End With
