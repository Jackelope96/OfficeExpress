  ...
  Public Class MaintenanceEditor
    ...
    Protected Friend Overrides Sub Setup()
      ...
      With Helpers
        ...
        If VM.IsStateless Then
          CType(Page, Singular.Web.PageBase).AddLateResource(Scripts.LibraryIncludes.MaintenanceScript.ScriptTag)
        End If
    ...
    Private Sub AddTable(Helpers As Controls.HelperControls.HelperAccessors(Of MaintenanceVM))
    ...
    Private Sub AddForm(Helpers As Controls.HelperControls.HelperAccessors(Of MaintenanceVM))
    ...
    Private Sub AddCustomControl(Helpers As Controls.HelperControls.HelperAccessors(Of MaintenanceVM))
