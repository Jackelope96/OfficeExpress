...
Namespace ServiceHelpers
  ...
  Public Class ServiceVM(Of VM)
    ...
    Public Shared Function SaveList(List As Singular.Service.ServerProgramTypeList) As Singular.Web.SaveResult
    ...
    <Singular.Web.WebCallable>
    Public Shared Function ExportLog(ScheduleID As Integer, ToDate As Date) As Singular.Documents.Document
    ...
    Public Shared Function GetProgress(ScheduleID As Integer, ToDate As Date) As Singular.Web.Result
    ...
    <Singular.Web.WebCallable>
    Public Shared Sub SendServiceMessage(ServerProgramID As Integer, MethodName As String, <Singular.Web.JSonString> MethodArgs As String)
