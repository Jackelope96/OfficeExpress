...
Namespace AuditTrails
  ...
  Public Class AuditTrailLookup
    ...
    Public Shared Function Create(AuditTrailTableList As ROAuditTrailTableList, ViewModel As IViewModel, Optional ChildLevelsToFetch As Integer = 0)
      Dim atl As New AuditTrailLookup
      atl._AuditTrailTableList = AuditTrailTableList

      If ChildLevelsToFetch > 0 Then
        AuditTrailTableList.FetchChildren(AuditTrailTableList, ChildLevelsToFetch)
      End If
