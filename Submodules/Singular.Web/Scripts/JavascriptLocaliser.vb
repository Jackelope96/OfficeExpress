Namespace Scripts
  ...
  Public Class JavascriptLocaliser
    ...
    Friend Shared Function GetLocalisedResourceStrings(CultureCode As String) As Byte()
    ...
    Friend Shared Function LocalisedScriptURL(CultureCode As String) As String
      ...
      'Return VirtualPathUtility.ToAbsolute(Scripts.GetPath(ScriptLocation.Project) & "/" & LocalJSFileName(Singular.Localisation.CurrentCulture.TwoLetterISOLanguageName))
    End Function
